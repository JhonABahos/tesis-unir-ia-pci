...
def get_deeplabv3_model(num_classes, pretrained=True):
    ...
    :param num_classes: Número de clases para la segmentación (20 daños + 1 fondo).
    :param pretrained: Booleano que indica si usar pesos preentrenados.
    :return: Modelo DeepLabV3 modificado con el número de clases configurado.
    """
    ...
    # Reemplazar la última capa de la red de clasificación para el número de clases deseado
    model.classifier[4] = nn.Conv2d(256, num_classes, kernel_size=1)

    # Si el modelo tiene un clasificador auxiliar, también se ajusta para el número de clases
